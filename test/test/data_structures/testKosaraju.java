...
public class testKosaraju {
	...
	@Before
	public void SetUp1() {
		grafo = new DiGraph<String, String>(13);
		...
		grafo.addEdge("6", "8", 0.0);
		grafo.addEdge("7", "6", 0.0);
		grafo.addEdge("7", "9", 0.0);
		grafo.addEdge("8", "6", 0.0);
	...
	public void Kosaraju() {
		KosarajuSharirSCC<String, String> ks = new KosarajuSharirSCC<String, String>(grafo);
		for (int i = 0; i < ks.ids().length; i++) {
			System.out.println(grafo.getVertex(""+i).getId()+" "+ks.id(grafo.getVertex(""+i)));
		}
